...
- UI Kit: **Argon Dashboard** (PRO Version) provided by **Creative-Tim**
- Jinja2 Theme: [Argon Dashboard PRO](https://github.com/app-generator/theme-jinja2-argon-dashboard-pro)
...
- [Flask Dashboard Argon PRO](https://flask-dashboard-argon-pro.appseed.us/login) - LIVE Demo
- [Flask Dashboard Argon PRO](https://appseed.us/admin-dashboards/flask-dashboard-argon-pro) - Official product page
...
![Flask Dashboard Argon PRO - Template project provided by AppSeed.](https://raw.githubusercontent.com/app-generator/flask-dashboard-argon-pro/master/media/flask-dashboard-argon-pro-screen.png)
...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-flask-dashboard-argon-pro.git
$ cd priv-flask-dashboard-argon-pro
$
...
---
[Flask Dashboard Argon PRO](https://appseed.us/admin-dashboards/flask-dashboard-argon-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
